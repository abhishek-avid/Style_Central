using Style_Central.API.Data.Entity;
using Style_Central.API.Data.Models;
using Style_Central.API.Helper;
...
namespace Style_Central.API.Repository.Service;
public class UserService : IUserService
{
    private readonly StyleCentralDbContext _db;
    private readonly IConfiguration _configuration;

    public UserService(StyleCentralDbContext db, IConfiguration configuration)
    {
        _db = db;

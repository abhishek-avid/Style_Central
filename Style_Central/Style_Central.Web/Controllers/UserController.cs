...
public class UserController : Controller
{
    ...
    [HttpPost]
    public async Task<APIResponseResult<UserModel>> LoginExistingUser([FromBody] LoginModel model)
    {
    ...
    [HttpPost]
    public async Task<APIResponseResult<string>> RegisterNewUser([FromBody] RegisterModel model)
    {
    ...
    public async Task<string> Logout()
    {
        ...
        Response.Cookies.Append("_BBCookie", "", expiredCookie);

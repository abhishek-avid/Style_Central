        ...
        columns: [
            { data: null },
            {
                data: null, className: 'td-name', render: function (data, type, row) {
                    ...
                    return `${row.name}<br><small>${shortdesc}</small>`;
                }
            },
            {
                ...
                data: 'quantity', className: 'td-number', render: function (data, type, row) {
                    return `<div class="input-group input-group-sm">
                            ...
                            <div class="btn-group btn-group-sm">
                                <button class="btn btn-round btn-info" onclick="updateQuantity(${row.id}, -1)"> <i class="mdi mdi-minus"></i> </button>
                                <button class="btn btn-round btn-info" onclick="updateQuantity(${row.id}, 1)"> <i class="mdi mdi-plus"></i> </button>
                            </div>`;
                }
            },
            {
            ...
            },
            {
                data: null, className: 'td-actions', sorting: false, render: function (data, type, row) {
                    return `<button type="button" rel="tooltip" data-placement="left" title="" class="btn btn-link cls-removeCartItem" onclick="removeItem(${row.id})">
